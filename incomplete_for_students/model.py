...
class Model(object):
    ...
    def update(self, dt):
        ...
        x= cos(self.theta) * linear_speed * dt
        y= sin(self.theta) * linear_speed * dt

        dx = x*cos(self.theta) - y*sin(self.theta)
        dy = x*cos(self.theta) + y*sin(self.theta)


        # Updating the robot position
        theta = dt * rotation_speed
        self.x = self.x + x     #self.x * cos(self.theta) - self.y * sin(self.theta)  # TODO
        self.y = self.y + y     #self.x * sin(self.theta) + self.y *cos(self.theta)
